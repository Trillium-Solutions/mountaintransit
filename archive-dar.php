...
new Array("Mojave Dial-A-Ride", "East Kern", "Monday thru Saturday", "7:00 AM to 6:00 PM", "dial-mojave", "e0871b", "dial-mojave.json",""),
new Array("Rosamond Dial-A-Ride", "East Kern", "Monday thru Saturday", "6:30 AM to 5:30 PM", "dial-rosamond", "e0871b", "dial-rosamond.json",""),
new Array("Tehachapi Dial-A-Ride", "East Kern", "Monday thru Saturday", "5:45 AM to 7:00 PM (Monday-Friday)\r7:30 AM to 5:30 PM (Saturday)", "dial-tehachapi", "e0871b", "dial-tehachapi.json",""),
...
for (var i = 0; i < dar_areas_arrayLength; i++) {
	 ...
	 dar_geojson[i] = L.geoJson(load_data(base_json_url + dar_areas_array[i][6]), {onEachFeature: onEachFeature, name:dar_areas_array[i][4], style: dar_styles[i]}).addTo(map);
