...
<font size="-2">e.g. Big Bear Community Hospital</font></td></tr> 
...
<tr class="min-hide">
<td><font size="-1"><input type="text" alt="Date" id="fdate2" size="10" name="date" value="" tabindex="1" maxlength="100"/>  <input type="text" id="ftime2" alt="Time" size="10" name="time" value="" tabindex="1" maxlength="100"/></font></td>
</tr>
<tr class="min-hide">
...
document.getElementById('ftime2').value=formatDate2(thisdate); 
...
document.getElementById('fdate2').value = month + '/' + day + '/' +  year ;
...
function update() {
    $('#ftime2').val(parseTime($('#ftime2').val(), format, step));   
}
...
$(document).ready( function() {
 ...
 $(function() {
    $( "#fdate2" ).datepicker({dateFormat: "mm/dd/yy"});
